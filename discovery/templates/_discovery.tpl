...
{{ printf "%s-discovery-db.%s.svc.cluster.local" (include "discovery.fullname" . ) (.Release.Namespace) }}
{{- end }}
...
{{ printf "%s-discovery-redis.%s.svc.cluster.local" (include "discovery.fullname" . ) (.Release.Namespace) }}
{{- end }}
